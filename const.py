...
NEWS_SOURCES = {
    ...
    'nelhage': {
        'name': 'Nelson Elhage',
        'feed_url': 'https://blog.nelhage.com/index.xml',
    ...
    'johnregehr': {
        'name': 'John Regehr',
        'feed_url': 'https://blog.regehr.org/feed',
    ...
    'catonmat': {
        ...
        'url': 'https://catonmat.net',
        'min_score': 0,
        'type': 'creator',
    },
    'hanselman': {
        'name': 'Scott Hanselman',
        'feed_url': 'https://feeds.hanselman.com/ScottHanselman',
        'url': 'https://www.hanselman.com/blog',
        'min_score': 0,
        'type': 'creator',
    },
    'smartlab': {
        'name': 'Smartlab (Wolfgang Beer)',
        'feed_url': 'https://www.smartlab.at/feed/',
        'url': 'https://www.smartlab.at',
        'min_score': 0,
        'type': 'creator',
    },
