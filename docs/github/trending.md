...
<div style="margin-bottom:1.5em; padding:1em; border:2px solid #f59e0b; border-radius:12px; background:#fffbeb;">
  <div style="display:flex; align-items:center; gap:0.5em; flex-wrap:wrap; margin-bottom:0.6em;">
    ...
    <span style="font-size:0.78em; color:#6b7280;">0 stars today</span>
  </div>
  <div style="display:flex; align-items:center; gap:0.5em; margin-bottom:0.5em; flex-wrap:wrap;">
    <img src="https://avatars.githubusercontent.com/u/4921183?v=4&s=32" alt="" width="32" height="32" style="border-radius:50%;">
    <strong style="font-size:1.2em;"><a href="https://github.com/kamranahmedse/developer-roadmap" target="_blank" rel="noopener">kamranahmedse/developer-roadmap</a></strong>
  </div>
  <p style="margin:0.3em 0; color:#374151;">Interactive roadmaps, guides and other educational content to help developers grow in their careers.</p>
  <div style="display:flex; gap:1em; font-size:0.85em; color:#6b7280; flex-wrap:wrap;">
    <span>&#9733; 350,112</span>
    <span>&#127860; 43,735</span>
    <span>TypeScript</span>
    <span>NOASSERTION</span>
  </div>
  <div style="margin-top:0.5em;"><a href="/tags/angular-roadmap/" style="display:inline-block; padding:1px 6px; margin:2px 2px 0 0; background:#fef3c7; border-radius:6px; color:#92400e; font-size:0.75em; text-decoration:none;">angular-roadmap</a> <a href="/tags/backend-roadmap/" style="display:inline-block; padding:1px 6px; margin:2px 2px 0 0; background:#fef3c7; border-radius:6px; color:#92400e; font-size:0.75em; text-decoration:none;">backend-roadmap</a> <a href="/tags/blockchain-roadmap/" style="display:inline-block; padding:1px 6px; margin:2px 2px 0 0; background:#fef3c7; border-radius:6px; color:#92400e; font-size:0.75em; text-decoration:none;">blockchain-roadmap</a> <a href="/tags/computer-science/" style="display:inline-block; padding:1px 6px; margin:2px 2px 0 0; background:#fef3c7; border-radius:6px; color:#92400e; font-size:0.75em; text-decoration:none;">computer-science</a> <a href="/tags/dba-roadmap/" style="display:inline-block; padding:1px 6px; margin:2px 2px 0 0; background:#fef3c7; border-radius:6px; color:#92400e; font-size:0.75em; text-decoration:none;">dba-roadmap</a> <a href="/tags/developer-roadmap/" style="display:inline-block; padding:1px 6px; margin:2px 2px 0 0; background:#fef3c7; border-radius:6px; color:#92400e; font-size:0.75em; text-decoration:none;">developer-roadmap</a> <a href="/tags/devops-roadmap/" style="display:inline-block; padding:1px 6px; margin:2px 2px 0 0; background:#fef3c7; border-radius:6px; color:#92400e; font-size:0.75em; text-decoration:none;">devops-roadmap</a> <a href="/tags/frontend-roadmap/" style="display:inline-block; padding:1px 6px; margin:2px 2px 0 0; background:#fef3c7; border-radius:6px; color:#92400e; font-size:0.75em; text-decoration:none;">frontend-roadmap</a></div>
</div>
